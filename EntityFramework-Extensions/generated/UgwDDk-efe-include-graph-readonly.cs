// Description: EFE - Include-graph - ReadOnly
// Website: https://entityframework-extensions.net/
// Run: https://dotnetfiddle.net/UgwDDk
...
public class Program
{
	public static void Main()
	{
		...
		invoices.Add(new Invoice() { Description = "Invoice_C", InvoiceItems = new List<InvoiceItem>() { new InvoiceItem() { Description = "Invoice_C_InvoiceItem_A" } , new InvoiceItem() { Description = "Invoice_C_InvoiceItem_B" }}});
		
		// ReadOnly: You can specify that some entities should not be inserted/updated by marked marking them as ReadOnly. 
		using (var context = new EntityContext())
		{
