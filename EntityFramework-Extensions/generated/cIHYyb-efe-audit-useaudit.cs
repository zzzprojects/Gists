// Description: EFE - Audit - UseAudit
// Website: https://entityframework-extensions.net/
// Run: https://dotnetfiddle.net/cIHYyb
...
public class Program
{
	public static void Main()
	{
		...
		// UseAudit : Gets or sets if INSERTED and DELETED data from the database should be returned as AuditEntries.
		using (var context = new EntityContext())
		{
			...
			{
				FiddleHelper.WriteTable(audit.Values);
			}
		}
	}
