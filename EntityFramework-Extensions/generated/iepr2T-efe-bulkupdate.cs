...
// Run: https://dotnetfiddle.net/iepr2T
...
public class Program
{
	public static void Main()
	{
		...
		// BulkUpdate: update data (easy to customize)
		using (var context = new EntityContext())
		{
			var list = context.Customers.ToList();
			...
			context.BulkUpdate(list, options => options.ColumnPrimaryKeyExpression = customer => customer.Code);
