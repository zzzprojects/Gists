// Description: EFE - Temporary-table - TemporaryTableSchemaName
// Website: https://entityframework-extensions.net/
// Run: https://dotnetfiddle.net/RjriRf
...
public class Program
{
	public static void Main()
	{
		...
		// TemporaryTableSchemaName: Gets or sets the schema name to use for the temporary table.
