...
// Run: https://dotnetfiddle.net/6BQAzg
...
public class Program
{
	public static void Main()
	{
		...
		EntityFrameworkManager.ContextFactory = context => new EntityContextChild();
	...
	public class EntityContextChild : EntityContext
	{
		public static string connection = @"Data Source=ZZZ_Projects.sdf";
		
		public EntityContextChild() : base(connection)
		{
