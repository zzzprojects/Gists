// Description: EFE - Temporary-table - UsePermanentTable
// Website: https://entityframework-extensions.net/
// Run: https://dotnetfiddle.net/B5qNg5
...
public class Program
{
	public static void Main()
	{
		...
		// UsePermanentTable: Gets or sets if the library should `create` and `drop` a permanent table instead of using a temporary table.
