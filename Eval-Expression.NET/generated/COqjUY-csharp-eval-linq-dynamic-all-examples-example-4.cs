// Description: C# Eval - linq-dynamic-all-examples - Example 4
// Website: https://eval-expression.net/
// Run: https://dotnetfiddle.net/COqjUY
...
public class Program
{
	public static void Main()
	{
		...
		foreach (var group in productGroups) 
		{
			...
			{
				Console.WriteLine("ProductID = " + "ProductName : " + product.ProductName+ " Category : "  + product.Category+" UnitPrice : "  + product.UnitPrice+ " UnitPrice : "  + product.UnitPrice+" UnitsInStock : " + product.UnitsInStock);
			}
		}
	}
	...
	{
		return  new List<Product>        {  new Product {ProductID = 1, ProductName = "Chai", Category = "Beverages", UnitPrice = 18.0000M, UnitsInStock = 39},
